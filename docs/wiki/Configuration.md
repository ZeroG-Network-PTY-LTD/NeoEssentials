...
This guide documents the actual configuration files and structure present in NeoEssentials. All examples are based on the real implementation and generated configuration files.
...
- `config.json` — Main configuration with all system settings
- `commands.json` — Command-specific configuration
...
├── homes/               # Home location data
├── warps/               # Warp location data
├── kits/                # Kit usage tracking
...
The main configuration file contains all system settings in a unified structure. This file is automatically generated with defaults and can be modified to customize mod behavior.
...
- Ensure modules are enabled in main config
...
- [Commands Reference](Essential-Commands.md)

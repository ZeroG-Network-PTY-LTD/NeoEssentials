...
```
essentials.home                    # Use /home command
essentials.sethome                 # Use /sethome command  
essentials.delhome                 # Use /delhome command
essentials.homes                   # Use /homes command
essentials.warp                    # Use /warp command
essentials.warps                   # List warps
essentials.spawn                   # Use /spawn command
essentials.back                    # Use /back command
essentials.msg                     # Send private messages
essentials.reply                   # Reply to messages
essentials.balance                 # Check balance
essentials.pay                     # Send money
```

### Administrative Permissions  
```
essentials.warp.set                # Create warps
essentials.warp.delete             # Delete warps
essentials.spawn.set               # Set spawn location

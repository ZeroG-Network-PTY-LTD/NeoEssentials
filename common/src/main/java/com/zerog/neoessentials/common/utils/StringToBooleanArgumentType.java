 ...
 * Version-independent implementation using plain strings for error messages
 */
public class StringToBooleanArgumentType implements ArgumentType<Boolean> {
    ...
    private static final SimpleCommandExceptionType ERROR = new SimpleCommandExceptionType(() -> "Expected boolean value (on/off/true/false)");

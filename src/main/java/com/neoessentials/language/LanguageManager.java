package com.neoessentials.language;
...
public class LanguageManager {
    ...
    public String formatMessage(String key, ServerPlayer player, Object... args) {
        ...
        if (args.length > 0) {
            try {
                ...
                // Fallback to simple replacement for numbered placeholders
    ...
    public Component getMessage(ServerPlayer player, String key, Object... args) {
    ...
    public Component getComponent(String key, ServerPlayer player, Object... args) {
        return getMessage(player, key, args);
    }

...
public class ConfigManager {
    ...
    private static final java.util.Map<String, Integer> EXPECTED_CONFIG_VERSIONS = new java.util.HashMap<>() {{
        put(MAIN_CONFIG, 29);          // v29 — webDashboard.serviceAccount, hologram/shop/auctionHouse/vault/tablist/resourcePacks/playerTags/discordIntegration module toggles + missing command entries

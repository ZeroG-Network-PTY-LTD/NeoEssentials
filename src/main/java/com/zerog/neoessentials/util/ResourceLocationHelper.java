...
/**
 * Helper class to safely create Identifier instances across different Minecraft versions.
 * This prevents classloading issues during JSON deserialization.
 */
public class ResourceLocationHelper {

    /**
     * Creates a Identifier from namespace and path.
    ...
    /**
     * Parses a Identifier from a string in format "namespace:path" or just "path".
     *
     * @param locationString The location string
     * @return A new Identifier instance
     */
    public static Identifier parse(String locationString) {

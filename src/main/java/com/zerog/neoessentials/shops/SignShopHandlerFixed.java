 ...
 */
public class SignShopHandlerFixed {
    private static final Logger LOGGER = LoggerFactory.getLogger(SignShopHandlerFixed.class);
    
    private final ShopManager shopManager;
    
    public SignShopHandlerFixed(ShopManager shopManager) {

 ...
 */
public class SignShopHandlerCleaned {
    private static final Logger LOGGER = LoggerFactory.getLogger(SignShopHandlerCleaned.class);
    
    private final ShopManager shopManager;
    
    public SignShopHandlerCleaned(ShopManager shopManager) {

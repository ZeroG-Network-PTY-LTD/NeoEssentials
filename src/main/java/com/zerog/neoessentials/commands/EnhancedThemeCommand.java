...
/**
 * Enhanced Theme Command for NeoEssentials
 ...
 * @since 2.1.0
 */
public class EnhancedThemeCommand {
    private static final Logger LOGGER = LoggerFactory.getLogger(EnhancedThemeCommand.class);

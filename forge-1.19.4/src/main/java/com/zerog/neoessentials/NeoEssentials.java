...
import com.zerog.neoessentials.adapter.Forge1194AdapterFactory;
...
/**
 * Main mod class for Forge 1.19.4 version
 */
...
public class NeoEssentials {
    ...
    public NeoEssentials(IEventBus modEventBus) {
        ...
        adapterFactory = Forge1194AdapterFactory.getInstance();
